...
visualize(group_images(test_imgs_orig[0:20, :, :, :], 5), 'original')  # 显示所有的测试图像
visualize(group_images(test_border_masks[0:20, :, :, :], 5), 'borders')  # 显示所有的掩膜图像
visualize(group_images(img_truth[0:20, :, :, :], 5), 'gtruth')  # 显示所有的金标准图
...
# model.load_weights(path_experiment + name_experiment + '_' + 'last' + '_weights.h5')
...
print("y scores pixels: " + str(
    ...
    pred_imgs.shape[0] * pred_imgs.shape[2] * pred_imgs.shape[3]) + " (565*584==329960)")
print("y true pixels: " + str(
    y_true.shape[0]) + " (radius 270: 270*270*3.14==228906), including background around retina: " + str(
    gtruth_masks.shape[2] * gtruth_masks.shape[3] * gtruth_masks.shape[0]) + " (565*584==329960)")
